            ...
            <form wire:submit.prevent="ChangeBrandPhoto">
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-12">
                        <label for="name" class="form-label w-full flex flex-col sm:flex-row">Team Image: <span class="sm:ml-auto mt-1 sm:mt-0 text-xs text-slate-500">Required</span> </label>
