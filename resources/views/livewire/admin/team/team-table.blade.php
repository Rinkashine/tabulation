            ...
            <div class="intro-y col-span-12 sm:col-span-6 md:col-span-6 lg:col-span-3">
                <div class="box">
                        ...
                        <div class="absolute right-0 top-0 mr-5 mt-3 dropdown">
                            ...
                            <div class="dropdown-menu w-40">
                                <div class="dropdown-content">
                                    <button wire:click="selectItem({{ $team->id }},'edit')" class="dropdown-item w-full"> <i class="fa-solid fa-pen mr-1"></i> Edit </button>
                                    <button wire:click="selectItem({{ $team->id }},'change_photo')" class="dropdown-item w-full"> <i class="fa-solid fa-images mr-1"></i> Change Photo </button>
                                    <button wire:click="selectItem({{$team->id}},'delete')"  class="dropdown-item w-full"> <i class="fa-solid fa-trash mr-1"></i> Delete </button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center text-center lg:text-left p-5 ">
                        @if (Storage::disk('public')->exists('team/'.$team->photo))
                            <img src="{{ url('storage/team/'.$team->photo) }}" data-action="zoom" class="object-contain w-full h-56" alt="Missing team Image">
                        @else
